    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            catch(Exception e)
            {
                ...
                string s = e.ToString();
                string sadFace = ":(";
                // perhaps this return should be revised if its not in debug mode.
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            if (!hasRegistered)
            {
                ...
                return await RegisterNewUserFromExternalAccesToken(provider, verifiedAccessToken, externalAccessToken);
            }
        ...
        private async Task<IHttpActionResult> RegisterNewUserFromExternalAccesToken(string provider,
